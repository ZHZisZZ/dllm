...
class AnDQwen2Config(transformers.Qwen2Config):
    model_type = "andi-qwen2"  # <- NEW model_type


class AnDQwen2Model(transformers.Qwen2Model):

    def __init__(self, config: AnDQwen2Config):
...
class AnDQwen2LMHeadModel(transformers.Qwen2ForCausalLM):
    config: AnDQwen2Config

    def __init__(self, config):
        transformers.Qwen2PreTrainedModel.__init__(self, config)
        self.model = AnDQwen2Model(config)
...
transformers.AutoConfig.register("andi-qwen2", AnDQwen2Config)
transformers.AutoModel.register(AnDQwen2Config, AnDQwen2LMHeadModel)
transformers.AutoModelForMaskedLM.register(AnDQwen2Config, AnDQwen2LMHeadModel)
...
if __name__ == "__main__":
    ...
    config = AnDQwen2Config.from_pretrained(config_path)
